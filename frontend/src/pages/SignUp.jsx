    ...
    <div className='containerLogin'>
		...
		<div className="h-screen w-screen">
			...
			<div className="z-30 w-full h-screen flex flex-col flex-wrap absolute top-0 left-0 justify-center items-center ">
				...
				>
					<input type="checkbox" id="toggle" className="box__toggle w-full" hidden />
				...
				<div className="h-fit w-full flex flex-col items-center justify-center py-4">
					...
					<div className="flex items-center flex-col sm:flex-row gap-2" style={{width: "100%" }}>
						...
						<div className='nameDiv gap-y-2 sm:gap-0 w-full flex flex-nowrap justify-between'>
							<TextField className='fullname' id="outlined-basic" label="First name" variant="outlined" required/>
							<TextField className='fullname' id="outlined-basic" label="Last name" variant="outlined" required/>
						</div>
              	</div>
				...
				<div className="flex items-center flex-col sm:flex-row gap-2" style={{width: "100%" }}>
					...
					<TextField id="outlined-basic" label="E-mail" variant="outlined" required style={{width: "100%"}}/>
					</div>
              	</div>
				...
				<div className="flex flex-col h-full justify-evenly items-center gap-y-4">
					<div style={{width: "50%"}} className="flex flex-col justify-center items-center gap-y-2">
				...
				<div className='w-full flex justify-center'>
					<p className="flex gap-x-1 font-bold text-gray-500">Already have an account? 
